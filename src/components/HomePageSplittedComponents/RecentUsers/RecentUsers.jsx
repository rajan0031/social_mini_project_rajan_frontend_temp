...
const RecentUsers = () => {
    return (
        <div className="w-full p-4 bg-gray-200 rounded-lg shadow-lg h-full">
            <h2 className="text-2xl font-bold mb-4">
                <FaCoffee className="inline-block mr-2" /> Recent Users
            </h2>
            {/* Dummy recent users */}
            ...
            <h2 className="text-2xl font-bold mt-4 mb-2">
                <FaRocket className="inline-block mr-2" /> Join Us
            </h2>
            <p className="text-gray-700 mb-2">
                We aim to inspire, educate, and entertain. Our blog is a space where ideas flourish, and creativity knows no bounds.
            </p>
        </div>
    );
};
